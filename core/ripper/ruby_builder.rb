...
require_relative '../core_ext/hash/delete_at'
require_relative '../core_ext/array/flush'

require_relative '../ripper/ruby_builder/token'
require_relative '../ripper/ruby_builder/stack'

require_relative '../erb/stripper'
...
class Ripper
  class RubyBuilder < Ripper::SexpBuilder
    ...
    def initialize(src, filename = nil, lineno = nil)
      ...
      #remove the trailing whitespace form the input source code.
